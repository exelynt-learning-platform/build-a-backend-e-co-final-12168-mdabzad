...
class OrderServiceTest {
    ...
    void testCreateOrder_Success() throws Exception {
        ...
        // Using findByIdWithLock for pessimistic locking
    ...
    void testCreateOrder_InsufficientStock() {
        ...
        assertThrows(InsufficientStockException.class, () -> orderService.createOrder(user, "123 Street"));
        verify(orderRepository, never()).save(any(Order.class));
    }

    @Test
    void testCreateOrder_InvalidQuantity() {
        cartItems.get(0).setQuantity(0);
        when(cartService.getCartItems(user)).thenReturn(cartItems);

        assertThrows(ValidationException.class, () -> orderService.createOrder(user, "123 Street"));
    }
}
